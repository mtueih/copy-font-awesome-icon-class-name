...
This add-on adds a button to the Font Awesome icon details page. Clicking this button allows you to copy the class name of the current icon with a single click.
